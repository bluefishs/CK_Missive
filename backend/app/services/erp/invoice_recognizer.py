...
def recognize_invoice(file_path: str) -> RecognitionResult:
    ...
    """
    from .invoice_qr_decoder import scan_all_qr, parse_head_qr, parse_detail_qr
    from .invoice_ocr_parser import try_ocr
