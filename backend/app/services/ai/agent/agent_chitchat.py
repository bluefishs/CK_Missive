...
# 高信心閒聊模式：精確匹配的問候詞 / 短語
# 2026-05-16 retro B1 擴增：救坤哥體感 — 短模糊 query 不再 fall through 到 LLM Planning。
# 來源：shadow_trace 24h Top-N 慢 query 揭示「ok/幫我/介紹自身能力」等都跑 40-50s。
_CHITCHAT_EXACT: set[str] = {
    "早安", "午安", "晚安", "你好", "您好", "嗨", "哈囉",
    "hi", "hello", "hey", "good morning", "good afternoon", "good evening",
    "早", "安安", "哈嘍", "嗨嗨", "謝謝", "感謝", "掰掰", "再見",
    "bye", "thanks", "thank you",
    # B1 新增：短模糊 fast-path（避免 Ollama 跑 40s+ 出 25 char stub）
    "ok", "好", "嗯", "是", "對", "幫我", "怎樣",
    "?", "？", "...", "。",
}

# 閒聊前綴模式：以這些開頭的短句視為閒聊
# 2026-05-16 retro B1 擴增：補齊「你有什麼/介紹自身/我能做什麼」等語意等價 prefix。
_CHITCHAT_PREFIXES = (
    "你是誰", "你叫什麼", "你會什麼", "你能做什麼", "可以幫我什麼",
    "介紹一下", "自我介紹", "怎麼使用", "如何使用", "使用說明",
    "今天天氣", "講個笑話", "心情不好",
    # B1 新增：語意等價於既有 prefix，但用戶實際輸入的變體
    "你有什麼", "介紹自身", "介紹自己", "我能做什麼", "請問你",
)
