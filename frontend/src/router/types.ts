...
export const ROUTES = {
  ...
  CONTRACT_CASE_STAFF_CREATE: '/contract-cases/:caseId/staff/create',
  CONTRACT_CASE_STAFF_EDIT: '/contract-cases/:caseId/staff/:userId/edit',
  CONTRACT_CASE_VENDOR_CREATE: '/contract-cases/:caseId/vendors/create',
  CONTRACT_CASE_VENDOR_EDIT: '/contract-cases/:caseId/vendors/:vendorId/edit',
