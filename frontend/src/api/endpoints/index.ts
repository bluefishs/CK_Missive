...
import { AI_ENDPOINTS, DIGITAL_TWIN_ENDPOINTS, KNOWLEDGE_BASE_ENDPOINTS, MEMORY_ENDPOINTS } from './ai';
import { PM_ENDPOINTS, ERP_ENDPOINTS } from './erp';
import { ADMIN_DATABASE_ENDPOINTS, BACKUP_ENDPOINTS, DEPLOYMENT_ENDPOINTS, LINE_ENDPOINTS, DISCORD_ENDPOINTS, SECURE_SITE_MANAGEMENT_ENDPOINTS, TENDER_ENDPOINTS, WIKI_ENDPOINTS, SCHEDULER_EVENTS_ENDPOINTS } from './admin';
...
export const API_ENDPOINTS = {
  ...
  // 排程追溯 / 自省報告（57g）
  SCHEDULER_EVENTS: SCHEDULER_EVENTS_ENDPOINTS,
