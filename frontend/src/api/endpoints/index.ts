...
import { ADMIN_DATABASE_ENDPOINTS, BACKUP_ENDPOINTS, DEPLOYMENT_ENDPOINTS, LINE_ENDPOINTS, DISCORD_ENDPOINTS, SECURE_SITE_MANAGEMENT_ENDPOINTS, TENDER_ENDPOINTS } from './admin';
