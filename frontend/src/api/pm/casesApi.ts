...
export const pmCasesApi = {
  ...
  async summary(params?: { year?: number; include_converted?: boolean; status?: string; category?: string; staff_user_id?: number; search?: string; client_name?: string }): Promise<PMCaseSummary> {
