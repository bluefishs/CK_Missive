/**
 * SendDocumentCreatePage Smoke Test
 */
...
describe('SendDocumentCreatePage', () => {
  beforeEach(() => { vi.clearAllMocks(); });

  it('renders without crashing', async () => {
    const mod = await import('../../pages/SendDocumentCreatePage');
    const Component = mod.SendDocumentCreatePage || mod.default;
