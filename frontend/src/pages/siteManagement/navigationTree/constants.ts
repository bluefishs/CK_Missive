...
export const FALLBACK_VALID_PATHS: ValidPath[] = [
  ...
  { path: '/admin/ai-assistant', description: 'AI 助理管理（已整合至 /kunge/ops）' },
  { path: '/kunge', description: '坤哥 — Missive 意識體（主入口）' },
  { path: '/kunge/ops', description: '坤哥 — 運維儀表板（整合 admin/ai-assistant）' },
