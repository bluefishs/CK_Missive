 ...
 * Reason: Tab-inline editing within ERP Quotation detail page (8 fields).
 * Invoices are tightly coupled to the parent erpQuotationId and billing period context.
