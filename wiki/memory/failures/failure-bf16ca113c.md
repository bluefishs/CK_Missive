...
type: agent_memory
memory_type: failure
signature: bf16ca113c
tool_sequence: ["get_entity_detail", "search_documents", "search_entities"]
hit_count: 4
failure_count: 2
failure_rate: 0.500
active: false
expired_reason: stale >21d (last_seen 2026-05-07)
first_seen: 2026-05-01
last_seen: 2026-05-07
tags: [memory, failure, defensive]
---

# Failure Mode bf16ca113c

## Tool sequence（問題組合）

`get_entity_detail`, `search_documents`, `search_entities`
...
**觸發**：規劃包含 `get_entity_detail` + `search_documents` + `search_entities` 的組合
