...
# Failure Mode 82fed427f7

## Tool sequence（問題組合）

`find_correspondence`, `get_statistics`, `search_dispatch_orders`, `search_projects`
...
**觸發**：規劃包含 `find_correspondence` + `get_statistics` + `search_dispatch_orders` + `search_projects` 的組合
