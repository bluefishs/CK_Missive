...
## 使用者看到的（2 個項目）
- 3.系統監控　`/system`　→ frontend/src/pages/SystemMonitoringPage.tsx
- 資安管理　`/admin/security-center`　→ frontend/src/pages/SecurityCenterPage.tsx

## 它打哪些 API（走查實際觀測，非靜態推論）
- 本模組特有 **2** 個：
  - /api/security/owasp-summary
