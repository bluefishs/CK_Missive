...
| Fitness checks | 160 | `scripts/checks/*.py` |
| Architecture docs | 109 | `docs/architecture/*.md` |
| **Total** | **386** | 5 處散落 |
...
```
  ...
  governance_wiki_pages_total                               767.0
  kg_entities_total                                       49869.0
  memory_crystals_total                                       4.0
  memory_diary_days_total                                   121.0
  scheduler_job_last_run_age_seconds{job_id="cleanup_events"}       1709.3
  scheduler_job_last_run_age_seconds{job_id="ezbid_cache_refresh"}       1870.3
  scheduler_job_last_run_age_seconds{job_id="fitness_daily"}       1709.3
  scheduler_job_last_run_age_seconds{job_id="health_check_broadcast"}         72.2
  scheduler_job_last_run_age_seconds{job_id="integration_e2e_validation"}       1487.5
  scheduler_job_last_run_age_seconds{job_id="kg_metrics_refresh"}         62.2
  scheduler_job_last_run_age_seconds{job_id="memory_metrics_refresh"}         59.5
  scheduler_job_last_run_age_seconds{job_id="pcc_today_scrape"}       5470.4
  scheduler_job_last_run_age_seconds{job_id="proactive_trigger_scan"}       7199.3
  scheduler_job_last_run_age_seconds{job_id="process_reminders"}         72.2
  scheduler_job_last_run_age_seconds{job_id="security_scan"}       1708.7
  scheduler_job_last_run_age_seconds{job_id="tender_dashboard_warm"}         57.2
  scheduler_job_success_created{job_id="cleanup_events"} 1787248890.9
  scheduler_job_success_created{job_id="ezbid_cache_refresh"} 1787241530.8
  scheduler_job_success_created{job_id="fitness_daily"} 1787248891.0
  scheduler_job_success_created{job_id="health_check_broadcast"} 1787238228.1
  scheduler_job_success_created{job_id="integration_e2e_validation"} 1787249112.8
  scheduler_job_success_created{job_id="kg_metrics_refresh"} 1787237938.1
  scheduler_job_success_created{job_id="memory_metrics_refresh"} 1787237941.1
  scheduler_job_success_created{job_id="pcc_today_scrape"} 1787245129.9
  scheduler_job_success_created{job_id="proactive_trigger_scan"} 1787243401.0
  scheduler_job_success_created{job_id="process_reminders"} 1787238228.1
  scheduler_job_success_created{job_id="security_scan"} 1787248891.6
  scheduler_job_success_created{job_id="tender_dashboard_warm"} 1787237944.9
  ...
  scheduler_job_success_total{job_id="health_check_broadcast"}         42.0
  scheduler_job_success_total{job_id="integration_e2e_validation"}          1.0
  scheduler_job_success_total{job_id="kg_metrics_refresh"}         15.0
  scheduler_job_success_total{job_id="memory_metrics_refresh"}         15.0
  scheduler_job_success_total{job_id="pcc_today_scrape"}          1.0
  scheduler_job_success_total{job_id="proactive_trigger_scan"}          1.0
  scheduler_job_success_total{job_id="process_reminders"}         42.0
  scheduler_job_success_total{job_id="security_scan"}          1.0
  scheduler_job_success_total{job_id="tender_dashboard_warm"}         43.0
  shadow_baseline_call_total{provider="gemma-local"}         46.0
  shadow_baseline_latency_p95_ms{provider="gemma-local"}      90002.0
  shadow_baseline_rows_total{lookback_hours="24"}            46.0
  ...
  shadow_baseline_tool_use_count{provider="gemma-local",tool="get_statistics"}         12.0
  ...
  v7_reference_density_diary_pct                             23.8
  v7_soul_drift_lines                                         0.0
```

> ⚠️ **本次未抓到 4 項前次存在的 metric**：`shadow_baseline_tool_use_count{provider="gemma-local",tool="find_correspondence"}`, `shadow_baseline_tool_use_count{provider="gemma-local",tool="get_expense_overview"}`, `shadow_baseline_tool_use_count{provider="gemma-local",tool="get_unpaid_billings"}`, `shadow_baseline_tool_use_count{provider="gemma-local",tool="search_across_graphs"}`
...
| `pcc_today_scrape` | 1.5h | 1 | 0 | 🟢 |
| `ezbid_cache_refresh` | 0.5h | 3 | 0 | 🟢 |
| `cleanup_events` | 0.5h | 1 | 0 | 🟢 |
| `fitness_daily` | 0.5h | 1 | 0 | 🟢 |
| `security_scan` | 0.5h | 1 | 0 | 🟢 |
| `integration_e2e_validation` | 0.4h | 1 | 0 | 🟢 |
| `process_reminders` | 0.0h | 42 | 0 | 🟢 |
| `health_check_broadcast` | 0.0h | 42 | 0 | 🟢 |
| `kg_metrics_refresh` | 0.0h | 15 | 0 | 🟢 |
| `memory_metrics_refresh` | 0.0h | 15 | 0 | 🟢 |
| `tender_dashboard_warm` | 0.0h | 43 | 0 | 🟢 |
...
| 時間 | Job | 狀態 | 耗時 |
|---|---|---|---|
| 02:29:03 | `tender_dashboard_warm` | ✅ success | 1ms |
| 02:29:00 | `memory_metrics_refresh` | ✅ success | 749ms |
| 02:28:58 | `kg_metrics_refresh` | ✅ success | 15ms |
| 02:28:48 | `health_check_broadcast` | ✅ success | 16ms |
| 02:28:48 | `process_reminders` | ✅ success | 4ms |
| 02:24:09 | `tender_dashboard_warm` | ✅ success | 6310ms |
| 02:23:48 | `health_check_broadcast` | ✅ success | 52ms |
| 02:23:48 | `process_reminders` | ✅ success | 35ms |
| 02:19:03 | `tender_dashboard_warm` | ✅ success | 1ms |
| 02:18:48 | `health_check_broadcast` | ✅ success | 34ms |
