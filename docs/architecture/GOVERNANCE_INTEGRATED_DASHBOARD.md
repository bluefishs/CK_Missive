...
| Fitness checks | 159 | `scripts/checks/*.py` |
...
```
  ...
  governance_wiki_pages_total                               763.0
  kg_entities_total                                       49815.0
  memory_crystals_total                                       4.0
  memory_diary_days_total                                   120.0
  scheduler_job_last_run_age_seconds{job_id="cleanup_events"}       1703.2
  scheduler_job_last_run_age_seconds{job_id="ezbid_cache_refresh"}       2130.0
  scheduler_job_last_run_age_seconds{job_id="fitness_daily"}       1703.2
  scheduler_job_last_run_age_seconds{job_id="health_check_broadcast"}         33.0
  scheduler_job_last_run_age_seconds{job_id="integration_e2e_validation"}       1487.5
  scheduler_job_last_run_age_seconds{job_id="kg_metrics_refresh"}        323.0
  scheduler_job_last_run_age_seconds{job_id="memory_metrics_refresh"}        320.1
  scheduler_job_last_run_age_seconds{job_id="process_reminders"}         33.0
  scheduler_job_last_run_age_seconds{job_id="security_scan"}       1702.7
  scheduler_job_last_run_age_seconds{job_id="tender_dashboard_warm"}         18.1
  scheduler_job_success_created{job_id="cleanup_events"} 1787162497.1
  scheduler_job_success_created{job_id="ezbid_cache_refresh"} 1787162070.3
  scheduler_job_success_created{job_id="fitness_daily"} 1787162497.1
  scheduler_job_success_created{job_id="health_check_broadcast"} 1787158767.3
  scheduler_job_success_created{job_id="integration_e2e_validation"} 1787162712.8
  scheduler_job_success_created{job_id="kg_metrics_refresh"} 1787158477.3
  scheduler_job_success_created{job_id="memory_metrics_refresh"} 1787158480.5
  scheduler_job_success_created{job_id="process_reminders"} 1787158767.3
  scheduler_job_success_created{job_id="security_scan"} 1787162497.6
  scheduler_job_success_created{job_id="tender_dashboard_warm"} 1787158483.6
  ...
  scheduler_job_success_total{job_id="health_check_broadcast"}         19.0
  scheduler_job_success_total{job_id="integration_e2e_validation"}          1.0
  scheduler_job_success_total{job_id="kg_metrics_refresh"}          7.0
  scheduler_job_success_total{job_id="memory_metrics_refresh"}          7.0
  scheduler_job_success_total{job_id="process_reminders"}         19.0
  scheduler_job_success_total{job_id="security_scan"}          1.0
  scheduler_job_success_total{job_id="tender_dashboard_warm"}         20.0
  shadow_baseline_call_total{provider="gemma-local"}         36.0
  shadow_baseline_latency_p95_ms{provider="gemma-local"}      82190.0
  shadow_baseline_rows_total{lookback_hours="24"}            36.0
  ...
  shadow_baseline_tool_use_count{provider="gemma-local",tool="search_documents"}         16.0
...
> ⚠️ **本次未抓到 6 項前次存在的 metric**：`scheduler_job_last_run_age_seconds{job_id="pcc_today_scrape"}`, `scheduler_job_last_run_age_seconds{job_id="proactive_trigger_scan"}`, `scheduler_job_success_created{job_id="pcc_today_scrape"}`, `scheduler_job_success_created{job_id="proactive_trigger_scan"}`, `scheduler_job_success_total{job_id="pcc_today_scrape"}`, `scheduler_job_success_total{job_id="proactive_trigger_scan"}`
...
|---|---|---|---|---|
| `ezbid_cache_refresh` | 0.6h | 1 | 0 | 🟢 |
| `cleanup_events` | 0.5h | 1 | 0 | 🟢 |
| `fitness_daily` | 0.5h | 1 | 0 | 🟢 |
| `security_scan` | 0.5h | 1 | 0 | 🟢 |
| `integration_e2e_validation` | 0.4h | 1 | 0 | 🟢 |
| `kg_metrics_refresh` | 0.1h | 7 | 0 | 🟢 |
| `memory_metrics_refresh` | 0.1h | 7 | 0 | 🟢 |
| `process_reminders` | 0.0h | 19 | 0 | 🟢 |
| `health_check_broadcast` | 0.0h | 19 | 0 | 🟢 |
| `tender_dashboard_warm` | 0.0h | 20 | 0 | 🟢 |
...
| 時間 | Job | 狀態 | 耗時 |
|---|---|---|---|
| 02:29:42 | `tender_dashboard_warm` | ✅ success | 1ms |
| 02:29:27 | `health_check_broadcast` | ✅ success | 18ms |
| 02:29:27 | `process_reminders` | ✅ success | 10ms |
| 02:24:42 | `tender_dashboard_warm` | ✅ success | 1ms |
| 02:24:40 | `memory_metrics_refresh` | ✅ success | 927ms |
| 02:24:37 | `kg_metrics_refresh` | ✅ success | 14ms |
| 02:24:27 | `process_reminders` | ✅ success | 42ms |
| 02:24:27 | `health_check_broadcast` | ✅ success | 32ms |
| 02:19:42 | `tender_dashboard_warm` | ✅ success | 690ms |
| 02:19:27 | `health_check_broadcast` | ✅ success | 36ms |
