...
| **A103 RWD 整體調整規劃** | owner 09-05「檢視專案整體 RWD 設計與調整規劃」⇒ `RWD_REVIEW_20260905.md`：現況＝「窄了就藏」且門檻 992px 涵蓋筆電（今天應付款項、發票號碼兩例）。八條原則（金額永不隱藏／隱藏門檻降 768／判準看內容區寬／一套表格包裝／欄位三級 priority／手機卡片／側欄自動收合／量測閘門）＋ P0–P4 分階段。**待 owner 拍板原則與 P1–P3 順序**；建議先做 P0（止血）與 P4（量測） | 🔴 待 owner |
