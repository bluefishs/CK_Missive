...
| # | 待裁示 | 為什麼要 owner |
|---|---|---|
| **A80** | **42 組版次分身合併**：留舊版（有金流）→ legacy 改 XLS 編號、案名改完整案名 → 新版 soft-delete。**但舊新 `case_code` 42 組全不同**，19 組連承攬案也兩個——這就是 A61 那 40 筆的真身 | 刪 42 張報價單＋收掉新版的 PM 案／承攬案，不可逆；`B114-B026` 兩張都有金流 |
