...
# 1. Services 頂層散戶比例
# ----------------------------------------------------------------------------
echo -e "${CYAN}[1/74] Services directory entropy${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[2/74] Dead config reader scan (multi-target v3)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[3/74] SOUL.md mirror drift check${NC}"
if $STRICT; then
...
# 4. Wiki ↔ KG 雙向引用率
# ----------------------------------------------------------------------------
echo -e "${CYAN}[4/74] Wiki ↔ KG link audit${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[5/74] KG pgvector embedding coverage${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[6/74] Architecture standard docs presence${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[7/74] Agent evolution health${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[8/74] Dispatch cache contract${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[9/74] Stub import lint (DDD boundary)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[10/74] Memory Wiki metrics alive${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[11/74] SOUL evolution alive${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[12/74] Memory signal consumer lint${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[13/74] Cron health check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[14/74] Wiki Unicode dup check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[15/74] Integration liveness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[16/74] LINE notify 7d heartbeat${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[17/74] Alias RLS bidirectional check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[18/74] Memory Wiki freshness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[19/74] Generic filter audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[20/74] Role permissions consistency${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[21/74] Alias RLS coverage audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[22/74] Domain score freshness${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[23/74] Capability usage audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[24/74] ADR lifecycle check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[25/74] Dead UI detector${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[26/74] Lessons drift check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[27/74] Service line count check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[28/74] Paths sloppy calc guard${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[29/74] Contracts only import guard${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[30/74] Module portability audit (contracts/)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[31/74] Naming convention audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[32/74] Facade only check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[33/74] Toolkit sync audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[34/74] Transitive deps audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[35/74] queryKey drift audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[36/74] autobiography freshness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[37/74] cross-repo docker network audit (ADR-0043)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[38/74] docker compose volume consistency (L43)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[39/74] facade consumer audit (v6.10 P1)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[40/74] compose vs Dockerfile HEALTHCHECK SSOT (L45)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[41/74] cross-repo secret SSOT audit (L41)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[42/74] cross-repo SSO auth state audit (L44)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[43/74] DB schema drift audit (next_session_resume #1)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[44/74] container lifecycle audit (next_session_resume #4)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[45/74] subdomain registry audit (next_session_resume #3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[46/74] SSO autoload completeness audit (next_session_resume #7)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[47/74] startup dependency race audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[48/74] DB pool exhaustion audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[49/74] Synthetic baseline freshness audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[50/74] Frontend bundle size drift audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[51/74] Tender source freshness audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[52/74] container host dependency audit (L49)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[53/74] tender subscription scheduler watchdog (L48)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[54/74] powershell utf-8 bom audit (L49 #11)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[55/74] tender enrichment freshness (ADR-0046)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[56/74] tender review queue health (ADR-0046 task E)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[57/74] container env alignment audit (L51 LINE incident)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[58/74] agent query starvation check (L51.7 kunge review)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[59/74] diary density audit (L51.7 Sprint 2.P2.11)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[60/74] container image freshness check (L51 incident #8)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[61/74] facade adoption audit (P1.7 v6.12 路線)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[62/74] integration e2e validation (v6.13 整合連通 持續驗證)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[63/74] transaction pollution audit (L64 交易污染防復發)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[64/74] auth-state ssot audit (登入狀態單一權威, 防 SSO race 復發)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[65/74] uncommitted work audit (session 收尾完整性, 防寫好未接通)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[66/74] heterogeneous work audit (異質同工防增量, 防反覆回歸根源復發)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[67/74] code semantic duplication (程式圖譜自動發現異質同工候選)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[68/74] code graph orphan audit (圖譜 stale orphan 偵測, DRY-RUN 只報不刪)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[69/74] producer output watchdog (沉默成功偵測, 行為層自我檢核)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[70/74] tier1 shared package version skew (ck-auth 跨 consumer 版本對齊 / L80)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[71/74] shared vendored drift (@ck-shared/* vendored copies vs canonical / L80)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[72/74] sso_bridge conformance (跨 repo 安全契約：用 ck_auth verify / 守衛順序 / L80)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[73/74] csrf_service drift (pile↔lvrland 單一源守門 / L80)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[74/74] contract case_code coverage (進行中案件是否可做財務作業)${NC}"
