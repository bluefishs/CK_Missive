...
# 1. Services 頂層散戶比例
# ----------------------------------------------------------------------------
echo -e "${CYAN}[1/53] Services directory entropy${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[2/53] Dead config reader scan (multi-target v3)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[3/53] SOUL.md mirror drift check${NC}"
if $STRICT; then
...
# 4. Wiki ↔ KG 雙向引用率
# ----------------------------------------------------------------------------
echo -e "${CYAN}[4/53] Wiki ↔ KG link audit${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[5/53] KG pgvector embedding coverage${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[6/53] Architecture standard docs presence${NC}"
REQUIRED_DOCS=(
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[7/53] Agent evolution health${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[8/53] Dispatch cache contract${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[9/53] Stub import lint (DDD boundary)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[10/53] Memory Wiki metrics alive${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[11/53] SOUL evolution alive${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[12/53] Memory signal consumer lint${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[13/53] Cron health check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[14/53] Wiki Unicode dup check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[15/53] Integration liveness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[16/53] LINE notify 7d heartbeat${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[17/53] Alias RLS bidirectional check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[18/53] Memory Wiki freshness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[19/53] Generic filter audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[20/53] Role permissions consistency${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[21/53] Alias RLS coverage audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[22/53] Domain score freshness${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[23/53] Capability usage audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[24/53] ADR lifecycle check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[25/53] Dead UI detector${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[26/53] Lessons drift check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[27/53] Service line count check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[28/53] Paths sloppy calc guard${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[29/53] Contracts only import guard${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[30/53] Module portability audit (contracts/)${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[31/53] Naming convention audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[32/53] Facade only check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[33/53] Toolkit sync audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[34/53] Transitive deps audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[35/53] queryKey drift audit${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[36/53] autobiography freshness check${NC}"
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[37/53] cross-repo docker network audit (ADR-0043)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[38/53] docker compose volume consistency (L43)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[39/53] facade consumer audit (v6.10 P1)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[40/53] compose vs Dockerfile HEALTHCHECK SSOT (L45)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[41/53] cross-repo secret SSOT audit (L41)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[42/53] cross-repo SSO auth state audit (L44)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[43/53] DB schema drift audit (next_session_resume #1)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[44/53] container lifecycle audit (next_session_resume #4)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[45/53] subdomain registry audit (next_session_resume #3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[46/53] SSO autoload completeness audit (next_session_resume #7)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[47/53] startup dependency race audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[48/53] DB pool exhaustion audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[49/53] Synthetic baseline freshness audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[50/53] Frontend bundle size drift audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[51/53] Tender source freshness audit (v6.12 P3)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[52/53] container host dependency audit (L49)${NC}"
if $STRICT; then
...
# ----------------------------------------------------------------------------
echo -e "${CYAN}[53/53] tender subscription scheduler watchdog (L48)${NC}"
if $STRICT; then
